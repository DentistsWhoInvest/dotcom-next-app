  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start p-4 lg:w-1/3">
        ...
        <Link
          href={url}
          className="pt-2 text-sm font-semibold text-blue-primary"
        >
          Read More...
        </Link>
      </div>
...
const LargeCard = ({ title, type, url, imageUrl, imageAlt }: CardProps) => {
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start px-4 py-2 grow h-2/5">
...
const MediumCard = ({ title, type, url, imageUrl, imageAlt }: CardProps) => {
  return (
    ...
    >
      <div className="relative w-1/4 lg:w-full aspect-square max-h-full overflow-hidden">
        <Link href={url}>
          <Image
            src={imageUrl}
            alt={imageAlt || title}
