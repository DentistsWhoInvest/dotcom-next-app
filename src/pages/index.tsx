  ...
  return (
    <main>
      ...
      <section>
        ...
        <Link href="/about" className="orange-link-on-white" aria-label={pageData.founder_cta_link_description}>
          ...
          {pageData.what_we_do_reasons.map((reason: any) => {
            ...
            return (
              <div key={reason.id}>
                ...
                <Link href={reason.cta_navigation_url} aria-label={reason.cta_navigation_description}>
                  {reason.cta_text}
                </Link>
              </div>
            );
    ...
    <section className="enrolment">
        ...
        {pageData.courses.data.map((course: any) => {
          ...
          return (
            <div className="course" key={course.id}>
              <img src="/DWI-logo-circle.webp" alt="Coruse Created By Dr. James Martin" className="header"/>
              ...
              <Image src={replaceImageDomain(course.attributes.cover.data.attributes.formats.small.url)}
              ...
              <p className="tagline">{course.attributes.description}</p>
              <Link href={course.attributes.navigation_url} aria-label={ariaLabel}>
      ...
      <div className="extraCourse">
        <Link href="/100k" aria-label="Information about the 100k course">Psssssst – Principal dentists: want to add £100k to your turnover in the next 12 months..?</Link>
      </div>
        ...
        {pageData.metrics.map((metric: any) => {
          return (
            <div className="stat" key={metric.id}>
              <h2><span id="community-members">{metric.value}</span></h2>
              <p>{metric.title}</p>
            </div>
          )
        })
          ...
          return (
            <div className="card" key={testimonial.id}>
              <div className="testimonial">
                <img className="quote" src="/quote.webp" alt="quote-mark"/>
                ...
                <div className="stars">
                  <svg width="100" height="100" viewBox="0 0 24 24" fill="yellow" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L14.8536 8.71091L22 9.52786L17 14.4721L18.7071 21.4721L12 17.9442L5.29289 21.4721L7 14.4721L2 9.52786L9.14645 8.71091L12 2Z" fill="yellow" />
                  </svg>
                  <svg width="100" height="100" viewBox="0 0 24 24" fill="yellow" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L14.8536 8.71091L22 9.52786L17 14.4721L18.7071 21.4721L12 17.9442L5.29289 21.4721L7 14.4721L2 9.52786L9.14645 8.71091L12 2Z" fill="yellow" />
                  </svg>
                ...
                <div className="identity">
                  <Image src={replaceImageDomain(testimonial.attributes.author_thumbnail.data.attributes.formats.small.url)}
                         alt={testimonial.attributes.author_thumbnail.data.attributes.alternativeText}
                         width={testimonial.attributes.author_thumbnail.data.attributes.width}
                         height={testimonial.attributes.author_thumbnail.data.attributes.height}
