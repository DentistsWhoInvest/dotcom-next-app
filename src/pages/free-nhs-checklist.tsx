...
export default function FreeNHSChecklist() {
  return (
    <>
      <Head>
        <title>Free NHS Checklist - Dentists Who Invest</title>
        <meta
          name="Free NHS Checklist - Dentists Who Invest"
          content="Free NHS Checklist - Dentists Who Invest"
        />
      </Head>
      <main
